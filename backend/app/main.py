...
from app.routers import auth, people, appointments, todos, grocery, birthdays, today, accounts, medications, bp, bp_export, contacts, med_scan
...
app.include_router(med_scan.router)
